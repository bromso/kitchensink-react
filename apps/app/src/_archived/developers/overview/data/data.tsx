...
export const getActivityIcon = (type: RecentActivity["type"]) => {
  switch (type) {
    case "pull-request":
      return <Icon icon="lucide:git-pull-request" className="h-5 w-5 text-blue-500" />
    case "issue-closed":
      return <Icon icon="lucide:git-merge" className="h-5 w-5 text-green-500" />
    case "commit":
      return <Icon icon="lucide:git-commit" className="h-5 w-5 text-purple-500" />
    case "issue-opened":
      return <Icon icon="lucide:alert-circle" className="h-5 w-5 text-red-500" />
    default:
      return null
  }
}
