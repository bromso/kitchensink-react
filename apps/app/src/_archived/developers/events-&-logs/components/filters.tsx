        ...
        <TooltipProvider>
          <Tooltip>
            <TooltipTrigger asChild>
              <Button onClick={resetHandler} variant="outline" className="px-3 text-xs">
                Reset
              </Button>
            </TooltipTrigger>
            <TooltipContent>
      ...
      <ScrollArea className="flex flex-col">
        <Collapsible defaultOpen className="group/log-filter px-2">
          <CollapsibleTrigger asChild>
            <Button className="flex w-full items-center justify-start px-2" variant="ghost">
              <Icon
                icon="lucide:chevron-right"
                className="scale-125 transition-transform duration-200 group-data-[state=open]/log-filter:rotate-90"
              />
          ...
          <CollapsibleContent className="CollapsibleContent space-y-2 px-2 pt-1 pb-3 duration-75!">
            <Select value={timeline} onValueChange={(e) => setTimeline(e as Timeline)}>
                  ...
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => {
                      return checked
                        ...
                        : setContainLevels(
                            containsLevels.filter((value) => value !== contain_level.label)
                          )
                    }}
