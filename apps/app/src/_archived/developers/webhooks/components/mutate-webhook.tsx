...
import { type Webhook, webhookAuthTypeSchema, webhookEventSchema } from "../data/schema"
          ...
          >
            <FormField
              ...
              render={({
                ...
                field: ControllerRenderProps<z.infer<typeof formSchema>, "url">
              }) => (
            ...
            <FormField
              ...
              render={({
                ...
                field: ControllerRenderProps<z.infer<typeof formSchema>, "authType">
              }) => (
                <FormItem className="space-y-1">
                  ...
                  <FormControl>
                    ...
                    >
                      {["none", "application", "platform"].map((item) => (
                        <FormItem key={item} className="flex items-center space-y-0 space-x-3">
                          <FormLabel
                            className={cn(
                              "flex h-full w-full items-start gap-2 rounded-lg border px-2 py-4 font-normal capitalize sm:p-4",
                                  ...
                                  <Checkbox
                                    ...
                                    onCheckedChange={(checked) => {
                                      return checked
                                        ...
                                        : field.onChange(
                                            field.value?.filter((value) => value !== whEvent)
                                          )
                                    }}
                                  />
                                </FormControl>
