    ...
    <Card className="h-full">
      ...
      <CardContent className="grid gap-6">
        <div className="flex flex-wrap items-center justify-between gap-2">
          <div className="flex items-center space-x-4">
            <Avatar className="h-8 w-8">
              <AvatarImage src="/avatars/avatar-1.webp" alt="Image" />
          ...
          <Popover>
            <PopoverTrigger asChild>
              <Button variant="outline" className="h-7 py-0" size="sm">
                Member <Icon icon="lucide:chevron-down" className="text-muted-foreground" />
              </Button>
            </PopoverTrigger>
        ...
        <div className="flex flex-wrap items-center justify-between gap-2">
          <div className="flex items-center space-x-4">
            <Avatar className="h-8 w-8">
              <AvatarImage src="/avatars/avatar-5.webp" alt="Image" />
          ...
          <Popover>
            <PopoverTrigger asChild>
              <Button variant="outline" className="h-7 py-0" size="sm">
                Owner <Icon icon="lucide:chevron-down" className="text-muted-foreground" />
              </Button>
            </PopoverTrigger>
            <PopoverContent className="p-0" align="end">
              <Command>
        ...
        <div className="flex flex-wrap items-center justify-between gap-2">
          <div className="flex items-center space-x-4">
            <Avatar className="h-8 w-8">
              <AvatarImage src="/avatars/avatar-4.webp" alt="Image" />
        ...
        <div className="flex flex-wrap items-center justify-between gap-2">
          <div className="flex items-center space-x-4">
            <Avatar className="h-8 w-8">
              <AvatarImage src="/avatars/avatar-3.webp" alt="Image" />
        ...
        <div className="flex flex-wrap items-center justify-between gap-2">
          <div className="flex items-center space-x-4">
            <Avatar className="h-8 w-8">
              <AvatarImage src="/avatars/avatar-2.webp" alt="Image" />
