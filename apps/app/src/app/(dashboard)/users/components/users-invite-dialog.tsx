      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader className="text-left">
          <DialogTitle className="flex items-center gap-2">
            <Icon icon="tabler:mail-plus" /> Invite User
          </DialogTitle>
          <DialogDescription>
        ...
        <Form {...form}>
          <form id="user-invite-form" onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            <FormField
              ...
              name="email"
              render={({ field }: { field: ControllerRenderProps<UserInviteForm, "email"> }) => (
                <FormItem>
            ...
            <FormField
              control={form.control}
              name="role"
              render={({ field }: { field: ControllerRenderProps<UserInviteForm, "role"> }) => (
            ...
            <FormField
              control={form.control}
              name="desc"
              render={({ field }: { field: ControllerRenderProps<UserInviteForm, "desc"> }) => (
                <FormItem className="">
