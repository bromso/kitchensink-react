        ...
        <Form {...form}>
          <form id="user-form" onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            <FormField
              ...
              name="firstName"
              render={({ field }: { field: ControllerRenderProps<UserForm, "firstName"> }) => (
            ...
            <FormField
              control={form.control}
              name="lastName"
              render={({ field }: { field: ControllerRenderProps<UserForm, "lastName"> }) => (
                <FormItem className="grid grid-cols-6 items-center gap-x-4 space-y-0 gap-y-1">
            ...
            <FormField
              control={form.control}
              name="username"
              render={({ field }: { field: ControllerRenderProps<UserForm, "username"> }) => (
                <FormItem className="grid grid-cols-6 items-center gap-x-4 space-y-0 gap-y-1">
            ...
            <FormField
              control={form.control}
              name="email"
              render={({ field }: { field: ControllerRenderProps<UserForm, "email"> }) => (
                <FormItem className="grid grid-cols-6 items-center gap-x-4 space-y-0 gap-y-1">
            ...
            <FormField
              control={form.control}
              name="phoneNumber"
              render={({ field }: { field: ControllerRenderProps<UserForm, "phoneNumber"> }) => (
                <FormItem className="grid grid-cols-6 items-center gap-x-4 space-y-0 gap-y-1">
            ...
            <FormField
              control={form.control}
              name="role"
              render={({ field }: { field: ControllerRenderProps<UserForm, "role"> }) => (
                <FormItem className="grid grid-cols-6 items-center gap-x-4 space-y-0 gap-y-1">
            ...
            <FormField
              control={form.control}
              name="password"
              render={({ field }: { field: ControllerRenderProps<UserForm, "password"> }) => (
                <FormItem className="grid grid-cols-6 items-center gap-x-4 space-y-0 gap-y-1">
            ...
            <FormField
              ...
              render={({
                ...
                field: ControllerRenderProps<UserForm, "confirmPassword">
              }) => (
                <FormItem className="grid grid-cols-6 items-center gap-x-4 space-y-0 gap-y-1">
