            ...
            >
              <FormField
                ...
                render={({
                  ...
                  field: ControllerRenderProps<AccountDetailForm, "firstName">
                }) => (
                  <FormItem className="space-y-1">
                    <FormLabel>First Name</FormLabel>
                    <FormControl>
                      <Input placeholder="First name" {...field} readOnly={!isEdit} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({
                  ...
                  field: ControllerRenderProps<AccountDetailForm, "lastName">
                }) => (
                  <FormItem className="space-y-1">
                    <FormLabel>Last Name</FormLabel>
                    <FormControl>
                      <Input placeholder="Last name" {...field} readOnly={!isEdit} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({
                  ...
                  field: ControllerRenderProps<AccountDetailForm, "email">
                }) => (
                  <FormItem className="col-span-2 space-y-1">
                    <FormLabel>Email</FormLabel>
                    <FormControl>
                      <Input type="email" placeholder="Email" {...field} readOnly={!isEdit} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({
                  ...
                  field: ControllerRenderProps<AccountDetailForm, "phoneNumber">
                }) => (
                  <FormItem className="col-span-2 space-y-1">
                    <FormLabel>Phone Number</FormLabel>
                    <FormControl>
                      <Input placeholder="Phone number" {...field} readOnly={!isEdit} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({
                  ...
                  field: ControllerRenderProps<AccountDetailForm, "role">
                }) => (
                  <FormItem className="col-span-2 space-y-1">
                    <FormLabel>Role</FormLabel>
                    <FormDescription>
                      Indicates the user&apos;s assigned position and corresponding permissions
                      within the system.
                    </FormDescription>
                    <FormControl>
                      <RadioGroup
        ...
        <CardContent>
          <div className="grid gap-4">
            ...
            <div className="flex items-center justify-between space-x-4">
              ...
              <Button variant="destructive" onClick={() => setOpen("deactivate")}>
                Deactivate
              </Button>
            </div>
          </div>
