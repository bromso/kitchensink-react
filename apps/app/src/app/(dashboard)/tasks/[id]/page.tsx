...
import { getTaskById } from "@/data/services/tasks"
...
export default async function TaskDetailPage({ params }: Props) {
  ...
  const assignees = [
    { name: "Michael Kane", image: "/avatars/avatar-1.webp", role: "Tech Lead" },
    {
      name: "Olivier Giroud",
      image: "/avatars/avatar-2.webp",
      role: "Developer",
    },
    { name: "Isabella Chen", image: "/avatars/avatar-3.webp", role: "Designer" },
  ]
  const linkedItems = [
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-1">
                {priority?.value === "medium" && <Icon icon="tabler:arrow-right" />}
                {priority?.value === "high" && <Icon icon="tabler:arrow-up" />}
                <Badge
                  className={`text-xs ${
                    priority?.value === "high"
              ...
              <div>
                <div className="flex -space-x-2">
                  {assignees.map((assignee) => (
                    <Avatar key={assignee.name} className="border-background h-5 w-5 border-2">
        ...
        <Tabs defaultValue="description" className="w-full">
          ...
          <TabsContent value="description" className="mt-4">
            ...
            <div className="prose prose-sm text-muted-foreground max-w-none">
              <p>
                Currently, when a Member reports a physical card as lost, stolen, or damaged, they
                are automatically issued with a new card. This process needs to be redesigned to
            ...
            <div className="mt-6 space-y-6">
              ...
              <div className="flex items-start gap-3">
                <Avatar className="h-7 w-7">
                  <AvatarImage src="/avatars/avatar-1.webp" alt="Current User" />
              ...
              <div className="space-y-8">
                ...
                <div className="flex gap-3">
                  <Avatar className="h-7 w-7">
                    <AvatarImage src="/avatars/avatar-2.webp" alt="Olivier Giroud" />
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-muted-foreground mt-1 text-sm">
                      I&apos;ve started working on the API endpoints. We might need to add rate
                      limiting to prevent abuse of the replacement request endpoint.
                    </p>
                    <div className="mt-2 flex gap-2">
                      <Button
                        type="button"
                        variant="ghost"
                        className="text-muted-foreground hover:text-foreground h-auto px-1 py-0 text-[11px]"
                      >
                        Reply
                      </Button>
                      <Button
                ...
                <div className="flex gap-3">
                  <Avatar className="h-7 w-7">
                    <AvatarImage src="/avatars/avatar-1.webp" alt="Michael Kane" />
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-muted-foreground mt-1 text-sm">
                      Good point about rate limiting. Let&apos;s also make sure we implement proper
                      logging for all replacement requests. I&apos;ll update the technical
                      requirements.
                    </p>
                    <div className="mt-2 flex gap-2">
                      <Button
                ...
                <div className="flex gap-3">
                  <Avatar className="h-7 w-7">
                    <AvatarImage src="/avatars/avatar-3.webp" alt="Isabella Chen" />
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-muted-foreground mt-1 text-sm">
                      I&apos;ve prepared some mockups for the verification UI. Will share them in
                      tomorrow&apos;s design review. The focus is on making the 2FA process as
                      smooth as possible.
                    </p>
                    <div className="mt-2 flex gap-2">
                      <Button
