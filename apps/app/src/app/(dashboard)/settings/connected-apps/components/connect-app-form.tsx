...
export default function ConnectAppForm() {
  return (
    <>
      ...
      <Accordion type="single" collapsible className="my-10 flex w-full flex-col gap-4">
        {apps.map((app) => (
          <AccordionItem
            key={app.name}
            value={app.name}
            className="bg-card rounded-md border px-4 py-0"
          >
            <AccordionTrigger className="flex items-center hover:no-underline">
              ...
              <div className="mr-3 ml-auto flex h-full items-center gap-4">
                <Button
                  ...
                  className={cn("h-7 px-2 text-xs font-semibold", {
