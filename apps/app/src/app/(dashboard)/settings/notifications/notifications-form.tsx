      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        <FormField
          ...
          render={({
            ...
            field: ControllerRenderProps<z.infer<typeof notificationsFormSchema>, "type">
          }) => (
          ...
          <div className="space-y-4">
            ...
            <FormField
              ...
              render={({
                ...
                field: ControllerRenderProps<NotificationsFormValues, "marketing_emails">
              }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
            ...
            <FormField
              ...
              render={({
                ...
                field: ControllerRenderProps<NotificationsFormValues, "social_emails">
              }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
            ...
            <FormField
              ...
              render={({
                ...
                field: ControllerRenderProps<NotificationsFormValues, "security_emails">
              }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
        ...
        <FormField
          ...
          render={({
            ...
            field: ControllerRenderProps<NotificationsFormValues, "mobile">
          }) => (
